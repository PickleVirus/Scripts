...
/****** Object:  Job [Back Up Database SES, DiscountShop, SES_DC, TerminalSAP: Mon Thu Sun]    Script Date: 12/11/2015 14:42:07 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]]    Script Date: 12/11/2015 14:42:07 ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'Back Up Database SES, DiscountShop and TerminalSAP: Mon Thu Sun', 
		@enabled=1, 
		...
		@notify_level_page=0, 
		@delete_level=0, 
		@description=N'¬ыполнение полного резервного копировани¤ Ѕƒ: SES, DiscountShop, SES_DC, TerminalSAP с последующим архивированием и переносом на резервный сервер.', 
		@category_name=N'[Uncategorized (Local)]', 
		@owner_login_name=N'DIXY\backup', @job_id = @jobId OUTPUT
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [backup ses, discountshop and terminalsap]    Script Date: 12/11/2015 14:42:08 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'backup ses, discountshop, ses_dc and terminalsap', 
		@step_id=1, 
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'copy ses to backup_server', 
		...
		@retry_interval=0, 
		@os_run_priority=0, @subsystem=N'CmdExec', 
		@command=N'xcopy E:\dbbackup\SES.7z \\10.81.1.4\E$\bkpsrv\dbbackup_1 /Y', 
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'copy discountshop to backup_server', 
		...
		@retry_interval=0, 
		@os_run_priority=0, @subsystem=N'CmdExec', 
		@command=N'xcopy E:\dbbackup\DiscountShop.7z \\10.81.1.4\E$\bkpsrv\dbbackup_1 /Y', 
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'copy terminalsap to backup_server', 
		...
		@retry_interval=0, 
		@os_run_priority=0, @subsystem=N'CmdExec', 
		@command=N'xcopy E:\dbbackup\TerminalSAP.7z \\10.81.1.4\E$\bkpsrv\dbbackup_1 /Y',
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'copy SES_DC to backup_server', 
		...
		@retry_interval=0, 
		@os_run_priority=0, @subsystem=N'CmdExec', 
		@command=N'xcopy E:\dbbackup\SES_DC.7z \\10.81.1.4\E$\bkpsrv\dbbackup_1 /Y',
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'Mon Thu Sun', 
		@enabled=1, 
		@freq_type=8, 
		@freq_interval=19, 
		@freq_subday_type=1, 
		...
		@schedule_uid=N'c77f769d-fb01-4271-b607-ea5d785c6c40'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
...
/****** Object:  Job [Back Up Database SES, DiscountShop and TerminalSAP: Tue Fri]    Script Date: 12/11/2015 14:56:22 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]]    Script Date: 12/11/2015 14:56:22 ******/
IF NOT EXISTS (SELECT name FROM msdb.dbo.syscategories WHERE name=N'[Uncategorized (Local)]' AND category_class=1)
BEGIN
EXEC @ReturnCode = msdb.dbo.sp_add_category @class=N'JOB', @type=N'LOCAL', @name=N'[Uncategorized (Local)]'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
...
DECLARE @jobId BINARY(16)
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'Back Up Database SES, DiscountShop and TerminalSAP: Tue Fri', 
		@enabled=1, 
		@notify_level_eventlog=0, 
		@notify_level_email=0, 
		@notify_level_netsend=0, 
		...
		@owner_login_name=N'DIXY\backup', @job_id = @jobId OUTPUT
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [backup ses, discountshop and terminalsap]    Script Date: 12/11/2015 14:56:23 ******/
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'copy ses to backup_server', 
		...
		@retry_interval=0, 
		@os_run_priority=0, @subsystem=N'CmdExec', 
		@command=N'xcopy E:\dbbackup\SES.7z \\10.81.1.4\E$\bkpsrv\dbbackup_2 /Y', 
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [copy discountshop to backup_server]    Script Date: 12/11/2015 14:42:09 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'copy discountshop to backup_server', 
		...
		@retry_interval=0, 
		@os_run_priority=0, @subsystem=N'CmdExec', 
		@command=N'xcopy E:\dbbackup\DiscountShop.7z \\10.81.1.4\E$\bkpsrv\dbbackup_2 /Y', 
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [copy terminalsap to backup_server]    Script Date: 12/11/2015 14:42:09 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'copy terminalsap to backup_server', 
		...
		@retry_interval=0, 
		@os_run_priority=0, @subsystem=N'CmdExec', 
		@command=N'xcopy E:\dbbackup\TerminalSAP.7z \\10.81.1.4\E$\bkpsrv\dbbackup_2 /Y',
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [copy SES_DC to backup_server]    Script Date: 12/11/2015 14:42:09 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'copy SES_DC to backup_server', 
		...
		@retry_interval=0, 
		@os_run_priority=0, @subsystem=N'CmdExec', 
		@command=N'xcopy E:\dbbackup\SES_DC.7z \\10.81.1.4\E$\bkpsrv\dbbackup_2 /Y',
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [delete backups]    Script Date: 12/11/2015 14:42:09 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'delete backups', 
...
EXEC @ReturnCode = msdb.dbo.sp_update_job @job_id = @jobId, @start_step_id = 1
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'Tue Fri', 
		@enabled=1, 
		@freq_type=8, 
		@freq_interval=36, 
		@freq_subday_type=1, 
		...
		@active_start_time=40000, 
		@active_end_time=235959, 
		@schedule_uid=N'6fbdd389-c9a6-4723-9c63-f9c7a3da436f'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_add_jobserver @job_id = @jobId, @server_name = N'(local)'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
COMMIT TRANSACTION
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'copy ses to backup_server', 
		...
		@retry_interval=0, 
		@os_run_priority=0, @subsystem=N'CmdExec', 
		@command=N'xcopy E:\dbbackup\SES.7z \\10.81.1.4\E$\bkpsrv\dbbackup_3 /Y', 
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [copy discountshop to backup_server]    Script Date: 12/11/2015 14:42:09 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'copy discountshop to backup_server', 
		...
		@retry_interval=0, 
		@os_run_priority=0, @subsystem=N'CmdExec', 
		@command=N'xcopy E:\dbbackup\DiscountShop.7z \\10.81.1.4\E$\bkpsrv\dbbackup_3 /Y', 
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [copy terminalsap to backup_server]    Script Date: 12/11/2015 14:42:09 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'copy terminalsap to backup_server', 
		...
		@retry_interval=0, 
		@os_run_priority=0, @subsystem=N'CmdExec', 
		@command=N'xcopy E:\dbbackup\TerminalSAP.7z \\10.81.1.4\E$\bkpsrv\dbbackup_3 /Y',
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [copy SES_DC to backup_server]    Script Date: 12/11/2015 14:42:09 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'copy SES_DC to backup_server', 
		...
		@retry_interval=0, 
		@os_run_priority=0, @subsystem=N'CmdExec', 
		@command=N'xcopy E:\dbbackup\SES_DC.7z \\10.81.1.4\E$\bkpsrv\dbbackup_3 /Y',
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [delete backups]    Script Date: 12/11/2015 14:42:09 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'delete backups', 
